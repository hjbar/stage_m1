...
module Make (T : Utils.Functor) = struct
  ...
  *)
  ...
  (** [term] are terms using [F.TeVar.t] variables, which include a unique stamp
      to guarantee uniqueness of binders. This is what most of the code
      manipulates. *)
  ...
  let freshen : raw_term -> term =
    ...
    let rec freshen env = function
      ...
      | Annot (t, ty) -> Annot (freshen env t, F.freshen_ty ty)
